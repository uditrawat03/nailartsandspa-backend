...
<head>
  ...
  <!-- summernote -->
  <link rel="stylesheet" href="{{ asset('assets/css/plugins/summernote/summernote-bs4.min.css')}}">
</head>
...
<div class="wrapper">
  ...
  <div class="preloader flex-column justify-content-center align-items-center">
    <img class="animation__shake" src="{{ asset('assets/images/nailandarts/logo.png')}}" alt="Nail&ArtSpa" height="60" width="60">
  </div>
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index3.html" class="brand-link">
      <img src="{{ asset('assets/images/nailandarts/logo.png')}}" alt="Nail&ArtSpa" class="brand-image img-circle elevation-3" style="background: white;">
      <span class="brand-text font-weight-light">Nail&ArtSpa</span>       
    </a>
